    ...
    <div className="space-y-2 md:space-y-4 text-sm sm:text-base md:w-full w-3/4 break-words">
      {exercise.target && (
        <div className="bg-third p-4 rounded-xl shadow">
          <strong className="text-orange">Hedef Kas:</strong> {exercise.target}
        </div>
      )}

      {exercise.equipment && (
        <div className="bg-third p-4 rounded-xl shadow">
          <strong className="text-orange">Ekipman:</strong> {exercise.equipment}
        </div>
      )}

      {exercise.bodyPart && (
        <div className="bg-third p-4 rounded-xl shadow">
          <strong className="text-orange">Çalışan Bölge:</strong> {exercise.bodyPart}
        </div>
      )}
